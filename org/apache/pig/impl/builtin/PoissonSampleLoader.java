...
//  private final Log log = LogFactory.getLog(getClass());
	 ...
	 * @author iman
	 */
	public boolean isEquivalent(LoadFunc func) {
		// TODO Auto-generated method stub
		if(func instanceof PoissonSampleLoader && loader==((PoissonSampleLoader) func).loader && numSamples==((PoissonSampleLoader) func).numSamples){
			return true;
		}
		return false;
	}
