...
public class TextLoader extends LoadFunc implements LoadCaster {
	 ...
	 */
    @Override
	public boolean isEquivalent(LoadFunc loader) {
		// TODO Auto-generated method stub
		if(loader instanceof TextLoader 
				&& in!=null && ((TextLoader) loader).in!=null
				/*&& in.isEquivalent(((TextLoader)loader).in)*/
				&& loadLocation.equals(((TextLoader) loader).loadLocation)){
			return true;
		}
		return false;
	}
