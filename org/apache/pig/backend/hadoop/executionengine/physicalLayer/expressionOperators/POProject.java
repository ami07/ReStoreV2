...
//            log.warn("No inputs found. Signaling End of Processing.");
	...
	public boolean isEquivalent(PhysicalOperator otherOP) {
		if(otherOP instanceof POProject){
			...
			if(resultType == ((POProject) otherOP).resultType && columns.containsAll(((POProject) otherOP).columns)&& star == ((POProject) otherOP).star && overloaded==((POProject) otherOP).overloaded){
				return true;
			}
		}
		return false;
