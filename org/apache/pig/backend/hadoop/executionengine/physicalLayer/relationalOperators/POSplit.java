...
public class POSplit extends PhysicalOperator {
	...
	public boolean isEquivalent(PhysicalOperator otherOP) {
		...
		if(otherOP instanceof POSplit){
			...
			if(splitStore==null && ((POSplit) otherOP).splitStore==null) return true;
			if(splitStore!=null && ((POSplit) otherOP).splitStore!=null && splitStore.isEquivalent(((POSplit) otherOP).splitStore)){
				return true;
			}
		}
		return false;
