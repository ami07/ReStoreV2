...
//            log.warn("No inputs found. Signaling End of Processing.");
     ...
     */
    @Override
    public Operator visit(PhyPlanVisitor v,List<Operator> pOps,boolean returnLastMatch) throws VisitorException {
        return v.visitPhyOp(this, pOps, true);
    }
     ...
     */
    @Override
    public void visit(PhyPlanVisitor v,Operator op) throws VisitorException {
         v.visitPhyOp(this, op);
    }
